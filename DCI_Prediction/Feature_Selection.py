...
def SelectFeatures_Recursive(X,y,cv):
    """
    This functions returns only the features selected using recursive feature elimination using LogisticRegression
    Cross-validation is already added to this function as a parameter
    Input: 
        X=training set
        y=training labels
...
def Change_One_Hot(frame,vals_mask,Y):
    """
